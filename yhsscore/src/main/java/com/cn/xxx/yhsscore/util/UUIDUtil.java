...
public class UUIDUtil {
	public static String NUMBER = "1-9";
	public static String LETTER = "a-zA-Z";
	public static String LOWLETTER = "a-z";
	public static String UPPERLETTER = "A-Z";
	public static String ALPHANUMERIC = "1-9a-zA-Z";
	 ...
	 * 
	 * **/
	public static String getUUID(int len,String type){
		String result = "" ;
		if(NUMBER.equals(type)){
			int num = (int)Math.pow(10,len-1);
			result += (int)((Math.random()*9+1)*num) ;
		}
	...
	public static void num1(){
		int num = (int)Math.pow(10,0);
		System.out.println((int)((Math.random()*9+1)*num));
	}
	/**
	 * 随机数字：定区间
	 * **/
    ...
    public static void main(String[] args) {  
        System.out.println("返回一个定长的随机字符串(包含大小写字母和数字):" + generateString(10));  
