...
SKY.CarouselItem = function(a, b) {
	...
	this.content = a.children(".sccontent");
	this.subscribers = {
		load: []
	};
	this.loaded = !1;
...
SKY.Carousel.prototype = {
	...
	initDOM: function() {
		...
		this.dom.wrapper = this.dom.carousel.children(".carouselwrapper");
		this.dom.container = this.dom.wrapper.children(".carouselcontainer");
		...
		a.preload && !1 != $.support.leadingWhitespace && (this.dom.wrapper.css({
			visibility: "hidden",
			opacity: 0
		}), a.showPreloader && (this.preloader = $('<div></div>'), this.dom.carousel.append(this.preloader)));
	...
	initContentWrapper: function() {
		var a = $('<div class="sccontentwrapper"></div>');
		this.contentContainer = $('<div class="sccontentcontainer"></div>');
	...
	initNavigationButtons: function() {
		...
		if (this.settings.navigationButtonsVisible) {
			var b = $('<a href="#" class="scnavbutton sc-prev sc-no-select"></a>'),
			c = $('<a href="#" class="scnavbutton sc-next sc-no-select"></a>');
			this.dom.carousel.append(b);
	...
	a.fn.carousel = function(b) {
		...
		this.each(function() {
			var d = a(this);
			d.data("carousel") || d.data("carousel", new SKY.Carousel(d, b));
			c.push(d.data("carousel"))
		});
...
function hideOtherLi(){
	$("#concert li").each(function(){
		var _this_zindex=$(this).css("z-index");
		if(_this_zindex!=3){
			console.log(_this_zindex);
			$(this).children(".sccontent").children("p").hide();
			console.log(1);
		}
		else{
			$(this).children(".sccontent").children("p").show();
		}
	});
}